...
public class LineView extends View {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (index) {
                ...
                case R.styleable.LineView_lineTextColor:
                    ...
                    break;
                case R.styleable.LineView_lineScaleColor:
                    mScaleColor = array.getColor(index, Color.BLACK);
                    break;
                case R.styleable.LineView_lineTextSize:
                    mTextSize = array.getDimensionPixelSize(index, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()));
                    break;
    ...
    public void setViewData(List<String> yList, List<String> xList,List<Float> datas) {
        this.mYList = yList;
        this.mXList = xList;
        this.datas = datas;
    }
    ...
    private List<Point> getPointList(List<Float> datas) {
        ...
        for (int i = 0; i < mXList.size(); i++) {
            ...
            point.y = mViewMargin + height * Float.valueOf(String.valueOf(1 - datas.get(i)));
            mList.add(point);
        }
        return mList;
    }
